  ...
  return (
    <div className="container mx-auto p-2 sm:mt-28 mt-14">
      <p className="text-xl font-bold">
        ...
        alike through the best in class odds, stats and predictive analysis on
        most professional sports. Our management team is made up of both
        professional athletes, tech gurus and most importantly, fans just like
        you!
      </p>
    </div>
  );
